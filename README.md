...
- **Full module stack** – Dashboard analytics, Tasks, Sponsor (with CSV export and coordinator-only mutations), Crew directory + avatar upload, threaded Community feed with moderation window, Notifications centre, and Settings with branding/theme controls.
